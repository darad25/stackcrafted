...
export const projects: Project[] = [
  {
    slug: "Steezely – AI Virtual Try-On App",
    title: "Steezely – AI Virtual Try-On App",
    description:
  ...
  },
  {
    ...
    title: "Steezely – AI Virtual Try-On",
    description:
      "Developed an AI-driven virtual try-on platform that helps users visualize fashion items before purchasing.",
    role: "fullstack",
  ...
  },
  {
    ...
    links: [
      { label: "Live", href: "https://daily-path.netlify.app/" },
      { label: "Code", href: "https://github.com/darad25/gamified-app" }],
    period: { year: "2025" },
    highlights: [
      "An immersive, RPG-inspired productivity engine. Transmute daily disciplines into legendary progress through an evolving quest map and mastery-based growth system.",
    ],
