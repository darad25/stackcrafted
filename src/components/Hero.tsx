      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid gap-8 lg:grid-cols-12 lg:gap-10 items-center" style={{ animation: "fade-in 600ms ease 1 both" }}>
          <div className="lg:col-span-7">
            <p className="text-6xl sm:text-6xl font-semibold tracking-[-0.02em] text-white/60">Hi, I&apos;m Oluwadara.</p>
            ...
            <p className="mt-5 text-2xl sm:text-2xl text-white/70 max-w-2xl">
